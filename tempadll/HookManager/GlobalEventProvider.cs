...
namespace Gma.UserActivityMonitor
{
    ...
    public class GlobalEventProvider : Component
    {
        ...
        #region Focus events
           private event EventHandler m_GotFocus;
        /// <summary>
        /// Occurs when a click was performed by the mouse. 
        /// </summary>
        public event EventHandler GotFocus
        {
            add
            {
                if (m_GotFocus == null)
                {
                    HookManager.GoogleGotFocus+= HookManager_GotFocus;
                }
                m_GotFocus += value;
            }
        ...
        void HookManager_GotFocus(object sender, EventArgs e)
        {
            if (m_GotFocus != null)
            {
                m_GotFocus.Invoke(this, e);
            }
        }
        #endregion
    }
